document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    questionCount.innerText = `Question ${currentQuestionIndex} of ${totalQuestions}`;
    ...
    */
    ...
    question.choices.forEach(choice => {
      ...
      choicelist.appendChild(linespace);
  ...
  function nextButtonHandler() {
    ...
    const allchoiceElement = document.querySelectorAll("input");

    Array.from(allchoiceElement).forEach(option => {
      if (option.checked) {
